...
const BdEvents = () => {
    ...
    <div className="container">
      <div className="row">
        ...
        <div className="col-sm-5">
          <div className="image-wrapper">
            <img src="home4-benefits.svg" alt="" />
            <span className="image-bar" />
          </div>
        </div>
      </div>
  ...
  <section className="branches">
    <h2>Our Branches In Bangladesh</h2>
    <div className="card1-container">
      <div className="card1">
        <h3>DHAKA (Banani)</h3>
        <p>
          <strong>Phone:</strong>{" "}
          <a href="tel:+880123456789" target="_blank">
            +880 9606 506060
          </a>
        </p>
        <p>
          <strong>Email:</strong>{" "}
          <a href="mailto:dhaka@studynet.com.au" target="_blank">
            dhaka@studynet.com.au
          </a>
        </p>
        <p>
          <strong>Address:</strong> House No 50(1st Floor), Rd No 2, Chairman
          Bari, Banani, Dhaka 1213
        </p>
      </div>
      <div className="card1">
        <h3>DHAKA (Dhanmondi)</h3>
        <p>
          <strong>Phone:</strong>{" "}
          <a href="tel:+880 9606 506060" target="_blank">
            +880 9606 506060
          </a>
        </p>
        <p>
          <strong>Email:</strong>{" "}
          <a href="mailto:dhanmondi@studynet.com.au" target="_blank">
            dhanmondi@studynet.com.au
          </a>
        </p>
        <p>
          <strong>Address:</strong> 27 Shaptak, Level 4, Road 27, Dhanmondi,
          Dhaka 1209
        </p>
      </div>
      <div className="card1">
        ...
        <p>
          <strong>Phone:</strong>{" "}
          <a href="tel:+880 9606 506080" target="_blank">
            +880 9606 506080
          </a>
        </p>
        <p>
          <strong>Email:</strong>{" "}
          <a href="mailto:chittagong@studynet.com.au" target="_blank">
            chittagong@studynet.com.au
          </a>
        </p>
        <p>
          <strong>Address:</strong> Aerial Legend, Level 3, 1080 CDA Avenue, GEC
          Circle, Chattogram 4000
        </p>
      </div>
      <div className="card1">
        <h3>SYLHET</h3>
        <p>
          <strong>Phone:</strong>{" "}
          <a href="tel:+880 9606 506090" target="_blank">
            +880 9606 506090
          </a>
        </p>
        <p>
          <strong>Email:</strong>{" "}
          <a href="mailto:sylhet@studynet.com.au" target="_blank">
            sylhet@studynet.com.au
          </a>
        </p>
        <p>
          <strong>Address:</strong> Level 12, Elegant Shopping Mall, Jallarpar
          Rd, Sylhet 3100
        </p>
      </div>
    </div>
